 ...
 */
final class ProjectsApiDocsTest extends TestCase
{
    ...
    private static function mountedRoutes(): array
    {
        ...
        $registry = new ModuleRegistry([new ProjectsModule()]);
    ...
    public function testEveryEntryIsWellFormed(): void
    {
        $permissions = array_map(
            ...
            (new ProjectsModule())->permissions(),
        );

        foreach ((new ProjectsModule())->apiDocs() as $doc) {
